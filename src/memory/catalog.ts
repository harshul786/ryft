...
const MEMORY_MODES: MemoryMode[] = [
  {
    ...
    prompt:
      "Use file-based memory carefully and keep entries small, durable, and actionable.",
  },
  {
    name: "hierarchy",
    description: "Hierarchy.md-first memory for agent-readable navigation.",
    prompt:
      "Maintain hierarchy.md files as maps for directories. Favor machine navigation over human prose.",
  },
  {
    name: "session",
...
export function resolveMemoryMode(name: string = "normal"): MemoryMode {
